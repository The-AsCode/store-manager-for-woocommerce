...
class ComposerAutoloaderInit8ca1004d92518d0dd9664a19c4b4e376
{
    ...
    public static function getLoader()
    {
        ...
        if ($useStaticLoader) {
            $includeFiles = Composer\Autoload\ComposerStaticInit8ca1004d92518d0dd9664a19c4b4e376::$files;
        } else {
            $includeFiles = require __DIR__ . '/autoload_files.php';
        }
        foreach ($includeFiles as $fileIdentifier => $file) {
            composerRequire8ca1004d92518d0dd9664a19c4b4e376($fileIdentifier, $file);
        }
...
function composerRequire8ca1004d92518d0dd9664a19c4b4e376($fileIdentifier, $file)
{
