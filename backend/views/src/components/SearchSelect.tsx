	...
	return (
		<Combobox value={ selected } onChange={ onChange }>
			<div className="wmx-relative">
				<div className="wmx-relative wmx-w-60 wmx-cursor-default !wmx-border !wmx-border-gray-200 wmx-overflow-hidden wmx-rounded wmx-bg-white wmx-text-left focus:wmx-outline-none focus-visible:wmx-ring-2 focus-visible:wmx-ring-white/75 focus-visible:wmx-ring-offset-2 focus-visible:wmx-ring-offset-teal-300">
					<Combobox.Input
